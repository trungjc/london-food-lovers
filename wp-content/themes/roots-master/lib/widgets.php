...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-primary',
    'before_widget' => '<section class="panel panel-default panel-Primary widget %1$s %2$s">',
...
//bottom widget
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-footer',
     'before_widget' => '<section class="col-md-3 col-xs-12  widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<h3>',
    'after_title'   => '</h3>',
