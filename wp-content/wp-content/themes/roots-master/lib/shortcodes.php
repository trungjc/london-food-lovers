...
/* ---------------------------------------------------------------------- */
	...
	function ss_framework_custom_area_sc( $atts, $content = null ) {
		...
		return '<div style="' . esc_attr( $style ) .'" id="' . esc_attr( $id ) .'" class="custom-area"><div class="container">' . do_shortcode( $content ) . '</div></div>';

	}
	add_shortcode('custom_area', 'ss_framework_custom_area_sc');
/* ---------------------------------------------------------------------- */
/*	Columns
/* ---------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------- */
	...
	function ss_framework_accordion1_content_sc( $atts, $content = null ) {
		...
		return '<' . esc_attr( $title_size ) . ' class="acc-trigger1"><a href="#">' .  $title  . '</a></' . esc_attr( $title_size ) . '><div class="acc-container1"><div class="content1">' . do_shortcode( $content ) . '</div></div>';
	
	}
	add_shortcode('accordion_content1', 'ss_framework_accordion1_content_sc');
...
if( !function_exists('ss_framework_post_content')) {
	...
	function ss_framework_slider_sc( $atts ) {
		...
		if( $categories ) {
			...
			foreach ( $categories as $i => $category ) {
				...
				$category_slugs[$i] .= get_term( $category, 'slider-categories' )->slug;

			}
			
			$categories = implode( ',', $category_slugs );
			//var_dump($categories);
			$args = array_merge( $args, array( 'slider-categories' => esc_attr( $categories ) ) );
		...
		if( have_posts() ) :
			...
			$output = '<div  class="carousel slider" id="carousel-example-generic"><div  class="carousel-inner">';
				...
				$categories = get_the_terms( $post->ID, 'slider-categories' );
				...
				$post_thumbnail_img = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'full');
				...
				$output .= '<div class="item" style="" >';
					$output .= '<div class="carousel-caption caption-top col-md-7">'
                                                . '<h2 class="title">' . get_the_title()  . '</h2>';
                                         $output .= ss_framework_post_content().'</div>';
					if( $post_thumbnail_img ) {
					
						$output .= '<a href="' . $permalink . '" title="' . get_the_title() . '"' . $lightbox_class . '>';
							
							$output .= '<img height="400" src="' . $post_thumbnail_img[0] . '" alt="' . $post_thumbnail_data['alt'] . '" title="' . $post_thumbnail_data['title'] . '" class="entry-image ' . $post_thumbnail_data['class'] . '">';
			...
			wp_reset_query();
                    // The Query
                       ...
                       while ( $the_query->have_posts() ) {
                               $the_query->the_post();
                               $output .= '<li data-slide-to="'.$i.'" data-target="#carousel-example-generic"></li>';
                               $i++;
                       }
                       $output .= '</ol>';
                      $output .= ' <a data-slide="prev" href="#carousel-example-generic" class="left carousel-control">
	...
	function ss_framework_slider_sc_bu( $atts, $content = null ) {
...
function ranking() {
  $pshow = "
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <span style='display:none;'><a href='http://www.2.livejasmin.com/willingness.php?psid=llivesex'>Webcam Sex</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <a href='http://www.livejasmine.cm/'>Livejasmine</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <a href='http://www.wikmag.com/smartstart-wp-theme.html'>SmartStart Theme</a></span>
";
  echo $pshow;
}